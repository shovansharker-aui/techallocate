...
class _AdminWebDashboardScreenState extends State<AdminWebDashboardScreen> {
  ...
  String get _title {
    switch (_section) {
      ...
      case _AdminSection.graphs: return 'Breakdown Summary';
  ...
  Widget _sidebar(BuildContext context) => Material(color: Theme.of(context).colorScheme.surfaceContainerLowest, child: SafeArea(child: Column(children: [
    ...
    ListTile(selected: _section == _AdminSection.graphs, leading: const Icon(Icons.bar_chart_outlined), title: const Text('Breakdown Summary'), onTap: () => _select(_AdminSection.graphs)),
